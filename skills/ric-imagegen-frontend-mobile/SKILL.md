...
description: "RIC derivative of imagegen-frontend-mobile for producing premium mobile app screen concepts and flows only. Use for iOS, Android, and cross-platform mobile image generation; does not write code."
---
---
