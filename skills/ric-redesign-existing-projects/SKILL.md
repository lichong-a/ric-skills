...
description: "RIC derivative of redesign-existing-projects for upgrading existing websites, apps, and admin systems. Audit first, preserve behavior, distinguish marketing redesigns from product/admin redesigns, and use ric-admin-console for Chinese enterprise back-office layouts, CRUD, permissions, and dense management UI."
---
---
