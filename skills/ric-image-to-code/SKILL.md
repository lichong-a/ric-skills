...
description: "RIC derivative of image-to-code for image-first frontend implementation. Use for generating or analyzing design references and coding websites to match; for admin screenshots, extract layout, menus, query cards, tables, auth states, and Chinese enterprise density, then follow ric-admin-console."
---
---
