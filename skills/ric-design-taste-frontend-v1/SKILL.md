...
description: "RIC derivative of the original taste-skill v1 for projects that need the older anti-slop frontend behavior. Use for backward-compatible landing pages, portfolios, and visual redesigns while still applying ric operating constraints such as skill retrieval, PowerShell preference, pnpm/FNM rules, and safe infrastructure boundaries."
---
---
